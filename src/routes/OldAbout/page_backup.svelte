...
<div class="layout">
    ...
    <div class="timeline">
        <div class="about">
            ...
            <br/>
            I'm a PhD student at the <Link text={"Scuola Normale Superiore "}/> supervised by <Link text={"Nina Otter"}/> and <Link text={"Fosca Giannoti"}/> on various projects <b>topological data analysis, climate science, explainable AI and animal communication</b>.
            I am a collaborator at <Link text={"CETI"}/> and was previously part of the <Link text={"NPL"}/> research lab where I worked with <Link text={"Giovanni Petri"}/>.
            <br/>
